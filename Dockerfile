...
ENV METAMOD_URL=https://github.com/alliedmodders/metamod-source/releases/download/2.0.0.1399/mmsource-2.0.0-git1399-linux.tar.gz
ENV COUNTER_STRIKE_SHARP_URL=https://github.com/roflmuffin/CounterStrikeSharp/releases/download/v1.0.367/counterstrikesharp-with-runtime-linux-1.0.367.zip
