...
ENV COUNTER_STRIKE_SHARP_URL=https://github.com/roflmuffin/CounterStrikeSharp/releases/download/v261/counterstrikesharp-with-runtime-build-261-linux-9c8f25f.zip
