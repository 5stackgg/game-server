...
ENV COUNTER_STRIKE_SHARP_URL=https://github.com/roflmuffin/CounterStrikeSharp/releases/download/v277/counterstrikesharp-with-runtime-build-277-linux-cdb7a6e.zip
