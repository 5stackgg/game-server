...
ENV COUNTER_STRIKE_SHARP_URL=https://github.com/roflmuffin/CounterStrikeSharp/releases/download/v300/counterstrikesharp-with-runtime-build-300-linux-ac38ec2.zip
