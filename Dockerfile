...
ENV COUNTER_STRIKE_SHARP_URL=https://github.com/roflmuffin/CounterStrikeSharp/releases/download/v299/counterstrikesharp-with-runtime-build-299-linux-cff24f4.zip
