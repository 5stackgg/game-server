...
ENV COUNTER_STRIKE_SHARP_URL=https://github.com/roflmuffin/CounterStrikeSharp/releases/download/v266/counterstrikesharp-with-runtime-build-266-linux-9c8f25f.zip
