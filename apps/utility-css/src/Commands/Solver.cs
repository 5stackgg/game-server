...
public partial class UtilityPracticePlugin
{
    ...
    [ConsoleCommand("utility_solver_solve", "Solves a throw onto a point (SwiftlyS2 only)")]
    ...
    // command.
    [ConsoleCommand("utility_solver_calibrate", "Checks the solver's premise (SwiftlyS2 only)")]
    [CommandHelper(whoCanExecute: CommandUsage.SERVER_ONLY)]
