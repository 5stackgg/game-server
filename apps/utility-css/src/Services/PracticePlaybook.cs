...
public class PracticePlaybook
{
    ...
    private List<UtilityPlaybookStep> _steps = new List<UtilityPlaybookStep>();
    ...
    public ePlaybookStart Start(string map)
    {
        ...
        UtilityPlaybook? playbook = Loaded;
        ...
        List<UtilityPlaybookStep> steps = PlaybookUtility.Ordered(playbook);
    ...
    public void Tick()
    {
        ...
        foreach (UtilityPlaybookStep step in PlaybookUtility.Due(_steps, _elapsedMs, elapsed))
        {
            Fire(step);
        }
    ...
    private void Fire(UtilityPlaybookStep step)
    {
    ...
    {
        string id = step.utility_lineup_id ?? "";
