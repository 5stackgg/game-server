...
public partial class NadePracticePlugin : BasePlugin
{
    ...
    private readonly ILogger<NadePracticePlugin> _logger;

    private Timer? _secondTimer;
    private Timer? _refillTimer;

    public override string ModuleName => "NadePractice";
    ...
    public NadePracticePlugin(
        ...
        PracticeDrill drill,
        ILogger<NadePracticePlugin> logger
    )
    {
        _config = config;
        _api = api;
