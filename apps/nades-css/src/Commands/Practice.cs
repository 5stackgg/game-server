...
public partial class NadePracticePlugin
{
    ...
    [ConsoleCommand("nade_practice_refresh", "Re-reads the practice session from the panel")]
    ...
    {
        $" {ChatColors.Green}nade practice",
    ...
    private void StartPlaybook(CCSPlayerController player, CommandInfo command)
    {
        ...
        IReadOnlyList<NadePlaybookStep> steps = _playbook.Steps;
        ...
        {
            NadePlaybookStep step = steps[index];
