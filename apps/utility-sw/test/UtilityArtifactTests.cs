...
public class UtilityArtifactTests
{
    ...
    {
        UtilityTrajectoryArtifact artifact = UtilityTrajectoryArtifact.Parse(Artifact);
    ...
    {
        SmokeVolume? volume = UtilityTrajectoryArtifact.Parse(Artifact).smoke_volume;
    ...
    public void AGzippedArtifactIsUnpackedFirst()
    {
        ...
        UtilityTrajectoryArtifact artifact = UtilityTrajectoryArtifact.Parse(compressed.ToArray());
    ...
    {
        UtilityTrajectoryArtifact artifact = UtilityTrajectoryArtifact.Parse(
    ...
    public void APlaybookOnTheSessionArrivesWithItsSteps()
    {
            ...
            .Deserialize<UtilitySessionRow>(
                """
                {
                  ...
                  "playbook": {
                    ...
                    "steps": [
                      {
                        "utility_lineup_id": "44444444-4444-4444-4444-444444444444",
                        "step_order": 1,
                        "offset_ms": 0,
        ...
        UtilityPlaybook? playbook = session.playbook;
    ...
    {
        UtilityPracticeResultPayload payload = UtilityPracticeResultPayload.For(
        ...
        Assert.Equal("44444444-4444-4444-4444-444444444444", payload.utility_lineup_id);
    ...
    public void AnUnknownSessionIsLeftOutOfTheResult()
    {
        ...
        Assert.Contains("\"utility_lineup_id\"", json);
    }

    [Fact]
    public void AResultIsReadBackWithThePanelsRadius()
    {
        UtilityPracticeResult? result = JsonSerializer.Deserialize<UtilityPracticeResult>(
            """
            {
              "success": true,
              "distance": 42.5,
